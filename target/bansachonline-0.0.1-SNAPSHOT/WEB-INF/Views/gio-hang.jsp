    				...
    				<div class="col-12 col-sm-8 col-md-8">
    					...
    					<table class="table " id="infor-sach">
  							...
  							<tbody>
  								...
  								<tr>
  									<td  class="product-giohang"><a href="/Chi-Tiet-San-Pham/Sach?MaSach=${Item.getMaSanPham()}"><img src="/resources/image/${Item.getAnhBia()}" alt="anh-ve-sach"></a></td>
    				...
    				<div class="col-12 col-sm-4 col-md-4">
    					...
    					<form>
  							<div class="form-group">
    							...
    							<input type="text" readonly class="form-control" value="${User.getHoTen()}" id="hoTen"/>
 							 </div>
 							 <div class="form-group">
    						<label >Số điện thoại liên hệ.</label>
    						<input type="text" readonly class="form-control"  value="${User.getDienThoai()}" id="soDT"/>
  							</div>
  							<div class="form-group">
    						<label  >Địa chỉ giao hàng.</label>
    						<input type="text" class="form-control" value="${User.getDiaChi()}" id="diaChi">
  							</div>
  							<div class="form-group">
    						<label>Ghi Chú.</label>
