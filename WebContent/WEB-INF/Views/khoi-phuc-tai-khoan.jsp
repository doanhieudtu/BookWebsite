...
<span class="active" id=""><h2>Khôi Phục Tài Khoản</h2></span>
<span class="active" id="">Nhập mật khẩu mới để khôi phục.</span>
</div>
...
<input type="password" id="matkhaulan1" placeholder="Mật khẩu( tối đa 8 kí tự )."/><br/>
<div class="background-icon-lock" >
<i class="fas fa-lock  fa-2x"></i>
</div>
<input type="password" id="matkhaulan2" placeholder="Nhập lại mật khẩu"/><br/>
</form>
<div id="btton-khoi-phuc" >Khôi phục</div></br>
</div>
