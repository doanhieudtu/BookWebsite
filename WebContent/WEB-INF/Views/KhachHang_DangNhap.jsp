        ...
        <div id="container-login">
            ...
            <div id="container-login-right">
                <div id="header-top-right" class="header-right">
                     <span class="active" id="login">Đăng Nhập</span> / <span id="singin" >Đăng Kí</span>
                </div>
                <div id="container-center-login-right">
                	<form>
                       ...
                       <div class="btton-dang-nhap" >Đăng Nhập</div></br>
                       <span id="thong-bao-dang-nhap"></span><br/>

                </div>
                <div id="container-center-signin-right">
                        <form action="/khach-hang/dang-ki" method="POST">
                            <div class="background-icon-email">
                                <i class="far fa-envelope fa-2x"></i>
                            </div>
                            ...
                            <input type="password" name="matkhaua" placeholder="Mật khẩu( tối đa 8 kí tự )."/><br/>
                            <div class="background-icon-lock" >
                                    <i class="fas fa-lock  fa-2x"></i>
                            </div>
                            <input type="password" name="matkhaub" placeholder="Nhập lại mật khẩu"/><br/>
                            <input type="submit" value="Đăng Kí"/>
                        </form>
                    </div>
                    <a id="KhoiPhucTK" style="display: none" href="/khoi-phuc-tai-khoan/">Khôi phục tài khoản.<a/>
                    <span>${Email}</span>
                    <span>${matkhau}</span>
                    <span>${Success}</span>
