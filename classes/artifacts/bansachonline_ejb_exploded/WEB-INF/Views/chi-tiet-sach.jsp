                    ...
                    <div class="collapse navbar-collapse navbar-home-lik-vv" id="navbarSupportedContent">
                      ...
                      <ul class="navbar-nav mr-auto narbar-menu">
                      	<li class="nav-item dropdown" >
                      		...
                      		<c:choose>
                      			<c:when  test="${user!='chuadangnhap'}">
                          			...
                          			<div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           			 	<a class="dropdown-item" href="/bansachonline/khach-hang/ho-so">Hồ Sơ Cá Nhân</a>
                       ...
                       <c:choose>
                      	...
                      	<a  href="/bansachonline/GioHang/"><i class="fas fa-cart-arrow-down fa-2x gioHang"></i></a>
                    </div>
                  </nav>
    </div>
    		...
    		<div id="Sach" class="col-12 col-sm-6 col-md-9">
    			<div class="row">
    				<div class="col-12 col-sm-4 col-md-4">
    					<img src="/bansachonline/resources/image/${Sach.getAnhBia()}" alt="anh-ve-sach"><br/>
    				</div>
