...
<!--js -->
<script src="<c:url value="/resources/jsAdmin/jquery.nicescroll.js"/>" ></script>
...
<!-- Bootstrap Core JavaScript -->
 <script src="<c:url value="/resources/jsAdmin/bootstrap.min.js"/>" ></script>
   <!-- /Bootstrap Core JavaScript -->	   
<!-- morris JavaScript -->	
<script src="<c:url value="/resources/jsAdmin/raphael-min.js"/>" ></script>
<script src="<c:url value="/resources/jsAdmin/morris.js"/>" ></script>
<script>
