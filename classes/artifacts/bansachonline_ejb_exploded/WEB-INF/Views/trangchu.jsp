           ...
           <c:forEach var="Sach" items="${ListSach}">
           		<div class="col-md-3 col-sm-6  wow rubberBand" data-wow-duration="1s" data-wow-delay="1s" >
              		<div class="product" hfr>
                  		<a href="/bansachonline/Chi-Tiet-San-Pham/Sach?MaSach=${Sach.getMaSach()}"><img src="/bansachonline/resources/image/${Sach.getAnhBia()}" alt="anh-ve-sach"></a><br/>
                  		<a href="/bansachonline/Chi-Tiet-San-Pham/Sach?MaSach=${Sach.getMaSach()}">Xem Chi Tiết<a/><br/>
              		</div>
          		</div>
           </c:forEach>
      </div>
